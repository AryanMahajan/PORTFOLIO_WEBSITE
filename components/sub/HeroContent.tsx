...
export default function HeroContent() {
  return (
    ...
    >
        ...
        >
            <Image src="/aryanmahajan.jpg" alt="work icons" height={450}width={450} className='rounded-full '/>
        ...
        <div className='h-full w-full flex flex-col justify-center lg:gap-3 text-start 2xl:ml-20'>
            ...
            >
                ...
                className='text-sm font-extralight lg:font-normal text-center lg:text-start lg:text-lg text-gray-400 lg:my-5 lg:max-w-[600px] w-[300px] h-auto mx-auto'
                >
